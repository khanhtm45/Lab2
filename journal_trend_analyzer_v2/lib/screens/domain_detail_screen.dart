  ...
  Widget _buildBody(
    ...
    return ListView(
                  ...
                  children: [
                    ...
                    ScreenSectionHeader(
                      title: s.publicationTrend,
                      subtitle: s.worksTaggedConcept,
                    ),
                    ...
                    MockupCard(
                      ...
                      child: TrendSectionCard(
                        yearlyData: _trend,
                        emptyMessage: s.noTrendForDomain,
                      ),
                    ),
                    const SizedBox(height: 24),
                    ScreenSectionHeader(
                      title: s.topPapers,
                      subtitle: s.mostCitedInDomain,
                    ),
                    ...
                    ScreenSectionHeader(
                      title: s.topAuthors,
                      subtitle: s.mostPublicationsInDomain,
                    ),
                    const SizedBox(height: 8),
                    if (_authors.isEmpty)
                      Text(
                        s.noAuthorDataDomain,
                        style: const TextStyle(color: AppColors.textSecondary),
                      )
                    else
                      MockupCard(
                    ...
                    ScreenSectionHeader(
                      title: s.topJournals,
                      subtitle: s.whereDomainPublishes,
                    ),
                    const SizedBox(height: 8),
                    if (_journals.isEmpty)
                      Text(
                        s.noJournalDataDomain,
                        style: const TextStyle(color: AppColors.textSecondary),
                      )
                    else
                      MockupCard(
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Text(
          context.strings.shareAmongDomains(domains.length),
          style: const TextStyle(
            color: AppColors.textSecondary,
            fontSize: 11,
          ),
