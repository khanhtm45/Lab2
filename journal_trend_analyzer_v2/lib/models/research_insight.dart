...
class TrendInsight {
  ...
  static TrendInsight emptyFor(AppStrings s) => TrendInsight(
        ...
        headline: s.insufficientInsightData,
        summary: s.notEnoughOpenAlexInsights,
      );

  @Deprecated('Use emptyFor(AppStrings)')
