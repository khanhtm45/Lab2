...
void main() {
  ...
  group('ResearchInsights.analyzeTrend', () {
    test('returns empty insight when fewer than two years', () {
      final insight = ResearchInsights.analyzeTrend(
        strings: s,
        volumeByYear: {2024: 10},
      );
      expect(insight, TrendInsight.emptyFor(s));
    });
  ...
  group('ResearchInsights copy helpers', () {
    test('influentialPapersInsight handles empty and landmark papers', () {
      expect(
        ResearchInsights.influentialPapersInsight(s, []),
      ...
      expect(
        ResearchInsights.influentialPapersInsight(s, [landmark]),
      ...
      expect(
        ResearchInsights.influentialPapersInsight(s, [regular]),
    ...
    test('researchLeadersInsight and journalPowerInsight', () {
      expect(
        ResearchInsights.researchLeadersInsight(s, []),
      ...
      expect(
        ResearchInsights.journalPowerInsight(s, []),
